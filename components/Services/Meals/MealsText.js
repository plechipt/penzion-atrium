  ...
  return (
    <div className=" w-full space-y-6 max-w-[720px]">
      <h2 className="text-2xl font-bold mb-2 text-center md:text-start">
        {tServices("mealsTitle")}
      </h2>
      <p className="text-gray-600">{tServices("mealsDescription0")}</p>
      ...
      <div className="mt-2">
        <p className="text-gray-600 mb-2">{tServices("mealsDescription1")}</p>
        <p className="text-gray-600 mb-2">{tServices("mealsDescription2")}</p>
        <p className="text-gray-600 mb-2">{tServices("mealsDescription3")}</p>
      </div>
    </div>
  );
};
